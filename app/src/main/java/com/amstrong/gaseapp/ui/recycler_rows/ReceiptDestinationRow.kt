...
import com.amstrong.gaseapp.databinding.RowReceiptRadioButtonBinding
...
class ReceiptDestinationRow (
    private val _receipt: Receipt,
    private val myOnCheckedChangedCallback: MyOnCheckedChanged,
) : BindableItem<RowReceiptRadioButtonBinding>(){

    override fun getLayout() = R.layout.row_receipt_radio_button

    val receipt: Receipt
        get() = _receipt

    override fun bind(viewBinding: RowReceiptRadioButtonBinding, position: Int) {
